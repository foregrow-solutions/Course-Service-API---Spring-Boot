document.addEventListener('DOMContentLoaded', async () => {
	...
	var email=localStorage.getItem("student_email");
	var name=localStorage.getItem("student_name");
	var url='api/student-create-payment-intent?student_email='+email+'&student_name='+name;
	...
	const form = document.getElementById('student-payment-form');
	let submitted = false;
	var spinner = $('#loader');
